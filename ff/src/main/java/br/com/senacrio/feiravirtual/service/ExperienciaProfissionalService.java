...
import br.com.senacrio.feiravirtual.repository.ExperienciaProfissionalRepository;
...
public class ExperienciaProfissionalService {
    ...
    @Autowired
    ExperienciaProfissionalRepository faRepo;


    public List<CurriculoExperienciaProfissional> findByUsuario(){
